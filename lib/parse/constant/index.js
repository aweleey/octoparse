...
let inline = makeMap("abbr,acronym,applet,b,basefont,bdo,big,br,button,cite,del,dfn,em,font,i,iframe,img,input,ins,kbd,label,map,object,q,s,samp,script,select,small,span,strike,strong,sub,sup,textarea,tt,u,let"); // Elements that you can, intentionally, leave open
...
export { startTag, endTag, attr, empty, block, inline, closeSelf, fillAttrs, special, __placeImgeUrlHttps };
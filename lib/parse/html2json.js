 ...
 * 
 */
import { urlToHttpUrl, removeDOCTYPE, trimHtml } from './utils/index';
import { HTMLParser } from './htmlparser';
import decode from './utils/decode';
import { block, inline, closeSelf, __placeImgeUrlHttps } from './constant/index';

function html2json(html, bindName = 'root', options = {}) {
  //处理字符串
  html = removeDOCTYPE(html);
  html = trimHtml(html);
  html = decode(html); //生成node节点
